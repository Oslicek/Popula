    ...
    <div className={styles.container}>
      ...
      <section className={styles.devTools}>
        <div className={styles.devToolsCard}>
          ...
          {/* Ping Worker */}
          <div className={styles.pingBar}>
            <span className={styles.pingLabel}>🏓 Ping Worker:</span>
            <input
              type="text"
              value={pingMessage}
            ...
            {lastPingResponse && (
              <span className={styles.pingReply}>
                → {lastPingResponse.reply}
              </span>
            )}
          </div>
          ...
          <div className={styles.devToolsGrid}>
            ...
            <div className={styles.devToolItem}>
              <h4>Connection</h4>
              <p>Reconnect to NATS message broker.</p>
              <button 
                className="btn btn-secondary"
